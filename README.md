...
[![API](https://img.shields.io/badge/API-54%20endpoint-0A7EA4)](backend/app/api.py)
[![Test](https://img.shields.io/badge/Test-20%20pytest-0A9EDC?logo=pytest&logoColor=white)](backend/tests)
