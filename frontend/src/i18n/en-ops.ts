...
addEn({
  ...
  'Apri Dispositivi': 'Open Devices',
  'Apri Eventi': 'Open Events',
  'Apri Gestione AP': 'Open AP management',
  'Apri il report': 'Open the report',
  'Azioni': 'Actions',
  'acceso da {t}': 'up for {t}',
  'occupato {p}%': '{p}% busy',
  'client': 'clients',
  'Clicca per vedere i dispositivi su questa banda': 'Click to see the devices on this band',
